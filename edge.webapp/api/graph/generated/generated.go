...
type ComplexityRoot struct {
	Mutation struct {
		ModifyRecord func(childComplexity int, input model.RecordInput) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.modifyRecord":
		if e.complexity.Mutation.ModifyRecord == nil {
			break
		}

		args, err := ec.field_Mutation_modifyRecord_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.ModifyRecord(childComplexity, args["input"].(model.RecordInput)), true
	...
	case "Record.content":
		...
		return e.complexity.Record.Content(childComplexity), true

	case "Record.markerURL":
		if e.complexity.Record.MarkerURL == nil {
			break
		}

		return e.complexity.Record.MarkerURL(childComplexity), true

	case "Record.sourceURL":
		if e.complexity.Record.SourceURL == nil {
			break
		}
	...
	case "Record.uniqueID":
		...
		return e.complexity.Record.UniqueID(childComplexity), true
...
func (ec *executionContext) field_Mutation_modifyRecord_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.RecordInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNRecordInput2githubᚗcomᚋtimothᚑyᚋscrapnoteᚑapiᚋedgeᚗwebappᚋcoreᚋmodelᚐRecordInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_modifyRecord(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Mutation_modifyRecord_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().ModifyRecord(rctx, args["input"].(model.RecordInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputRecordInput(ctx context.Context, obj interface{}) (model.RecordInput, error) {
	...
	for k, v := range asMap {
		...
		case "uniqueID":
			...
			it.UniqueID, err = ec.unmarshalNID2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "content":
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "modifyRecord":
			out.Values[i] = ec._Mutation_modifyRecord(ctx, field)
...
func (ec *executionContext) unmarshalNRecordInput2githubᚗcomᚋtimothᚑyᚋscrapnoteᚑapiᚋedgeᚗwebappᚋcoreᚋmodelᚐRecordInput(ctx context.Context, v interface{}) (model.RecordInput, error) {
